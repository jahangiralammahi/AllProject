...
<html>
    <head>
        <title>List of Terms And Condition</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>List Of Terms And Condition</h1>
            </div>
                ...
                <table class="table table-hover table-bordered table-responsive">
                    ...
                    <tbody>
                        ...
                        foreach ($obj as $arrays):
                            ...
                            <tr>
                                <td><?php echo $slno; ?></td>
                                <td><a href="show.php?id=<?php echo $arrays['id']; ?>"><?php echo $arrays['condition']; ?></a></td>
                                <td>
