...
<html>
    <head>
        <title>Edit SummerOfOrganization</title>
        <meta charset="UTF-8">
            ...
            <div class="col-md-4">
                <form role="form" action="update.php" method="post">
                    ...
                    <div class="form-group">
                        <label for="name">Edit Organization:</label>
                        <input type="text" class="form-control" id="name"  name="name" value="<?php echo $b->organization; ?>">
                    </div>
