...
namespace App\BITM\SEIP108475\TermsAndCondition;
...
//        Utility::dd($name);
        ...
        $query = "INSERT INTO `atomic_project`.`condition` (`id`,`condition`) VALUES (NULL,'$name')";
    ...
    public function show($id = '') {
        ...
        $con = mysql_connect("localhost", "root")or die("Mysql not connected");
        $dd = mysql_select_db('atomic_project');
        $q = "SELECT * FROM `condition` where `id`='$id'";
...
//        Utility::dd($result);
    ...
    public function update($id = '') {
        ...
        $conn = mysql_connect("localhost", "root")or die("Mysql not connected");
        $db = mysql_select_db('atomic_project');
        $query = "UPDATE `atomic_project`.`condition` SET  `condition` = '$this->name' WHERE `condition`.`id` = $this->id;";
...
//        Utility::d($query);
    ...
    public function delete($id = '') {
        ...
        $con = mysql_connect("localhost", "root")or die("Mysql not connected");
        $dd = mysql_select_db('atomic_project');
        $q = "DELETE FROM `atomic_project`.`condition` WHERE `condition`.`id` = $id";
