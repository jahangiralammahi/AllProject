...
namespace App\BITM\SEIP108475\City;
...
//         print_r($arr);
    ...
    public function store() {
        ...
        $query = "INSERT INTO `atomic_project`.`city` (`id`,`city`) VALUES (NULL,'$this->name')";
...
//        Utility::dd($result);
    ...
    public function update($id = '') {
        ...
        $conn = mysql_connect("localhost", "root")or die("Mysql not connected");
        $db = mysql_select_db('atomic_project');
        $query = "UPDATE `atomic_project`.`city` SET  `city` = '$this->name' WHERE `city`.`id` = $this->id;";
...
//        Utility::d($query);
    ...
    public function delete($id = '') {
        ...
        $con = mysql_connect("localhost", "root")or die("Mysql not connected");
        $dd = mysql_select_db('atomic_project');
        $q = "DELETE FROM `atomic_project`.`city` WHERE `city`.`id` = $id";
