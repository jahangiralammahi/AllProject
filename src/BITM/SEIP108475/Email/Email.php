...
namespace App\BITM\SEIP108475\Email;
...
//         print_r($arr);
    ...
    public function store() {
        ...
        $query = "INSERT INTO `atomic_project`.`email` (`id`,`email`) VALUES (NULL,'$this->name')";
...
//        Utility::dd($result);
    ...
    public function update($id = '') {
        ...
        $conn = mysql_connect("localhost", "root")or die("Mysql not connected");
        $db = mysql_select_db('atomic_project');
        $query = "UPDATE `atomic_project`.`email` SET  `email` = '$this->name' WHERE `email`.`id` = $this->id;";
...
//        Utility::d($query);
    ...
    public function delete($id = '') {
        ...
        $con = mysql_connect("localhost", "root")or die("Mysql not connected");
        $dd = mysql_select_db('atomic_project');
        $q = "DELETE FROM `atomic_project`.`email` WHERE `email`.`id` = $id";
