...
namespace App\BITM\SEIP108475\Hobby;
...
//         print_r($arr);
    ...
    public function store() {
        ...
        $query = "INSERT INTO `atomic_project`.`hobby` (`id`,`hobby`) VALUES (NULL,'$name')";
    ...
    public function show($id = '') {
        ...
        $con = mysql_connect("localhost", "root")or die("Mysql not connected");
        $dd = mysql_select_db('atomic_project');
        $q = "SELECT * FROM `hobby` where `id`='$id'";
...
//        Utility::dd($result);
    ...
    public function update($id = '') {
        ...
        $conn = mysql_connect("localhost", "root")or die("Mysql not connected");
        $db = mysql_select_db('atomic_project');
        $query = "UPDATE `atomic_project`.`hobby` SET  `hobby` = '$name' WHERE `hobby`.`id` = $this->id;";
...
//        Utility::d($query);
    ...
    public function delete($id = '') {
        ...
        $con = mysql_connect("localhost", "root")or die("Mysql not connected");
        $dd = mysql_select_db('atomic_project');
        $q = "DELETE FROM `atomic_project`.`hobby` WHERE `hobby`.`id` = $id";
