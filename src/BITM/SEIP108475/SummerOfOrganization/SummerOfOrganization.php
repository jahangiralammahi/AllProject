...
//         print_r($arr);
    ...
    public function store() {
        ...
        $query = "INSERT INTO `atomic_project`.`organization` (`id`,`organization`) VALUES (NULL,'$this->name')";
    ...
    public function show($id = '') {
        ...
        $con = mysql_connect("localhost", "root")or die("Mysql not connected");
        $dd = mysql_select_db('atomic_project');
        $q = "SELECT * FROM `organization` where `id`='$id'";
...
//        Utility::dd($result);
    ...
    public function update($id = '') {
        ...
        $conn = mysql_connect("localhost", "root")or die("Mysql not connected");
        $db = mysql_select_db('atomic_project');
        $query = "UPDATE `atomic_project`.`organization` SET  `organization` = '$this->name' WHERE `organization`.`id` = $this->id;";
...
//        Utility::d($query);
    ...
    public function delete($id = '') {
        ...
        $con = mysql_connect("localhost", "root")or die("Mysql not connected");
        $dd = mysql_select_db('atomic_project');
        $q = "DELETE FROM `atomic_project`.`organization` WHERE `organization`.`id` = $id";
